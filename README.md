...
I'm a software engineer by both trade and hobby, with 40+ years of programming experience — Not all of that professional, I started as a kid on my father's Apple II! My journey has taken me from writing code for tiny startups to massive enterprises, directly and indirectly, across many domains.
...
- **Languages (mainly):** TypeScript, C#
- **Other experience:** 30+ languages (and counting), not including markup!
- **Specialties:** Databases, multi-platform apps, full stack web development
...
- Tinkering with microcontrollers & robots
- Building a life-size, automated R2-D2
- Exploring new programming languages and frameworks
- Socially impactful software

## 📫 Connect with Me

[![LinkedIn](https://img.shields.io/badge/-LinkedIn-blue?style=flat-square&logo=linkedin)](https://www.linkedin.com/in/krisherlaar/)
[![My Resume](https://img.shields.io/badge/-CV-orange?style=flat-square&logo=read-the-docs)](https://www.theredhead.nl/cv.html)

## 💬 Favorite Quote

> "I'm a time traveler, always moving at one second per second."

---

_Thanks for stopping by! If you’re working on something cool or meaningful, let’s connect!_
